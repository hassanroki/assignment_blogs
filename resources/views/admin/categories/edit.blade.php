        ...
        <form action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-5">
                ...
                <input type="text" name="description"
                    ...
                    placeholder="Short description" value="{{ old('description', $category->description) }}">
            </div>
            ...
            @if ($category->image)
                <div class="mb-5">
                    ...
                    <img src="{{ asset('storage/' . $category->image) }}" class="w-40 h-28 rounded-lg border">
                </div>
            @endif

            {{-- Image Upload --}}
            <div class="mb-5">
                <label class="block font-semibold text-gray-700 mb-1">Change Image</label>
